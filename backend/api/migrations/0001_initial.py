# Generated by Django 4.1.5 on 2023-04-24 07:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('info', models.TextField()),
                ('countryCity_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='countryCity_id', to='api.countrycity')),
            ],
        ),
        migrations.CreateModel(
            name='Tours',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tour_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tour_id', to='api.tours')),
